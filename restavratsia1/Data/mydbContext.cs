    ...
    public partial class mydbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseMySql("server=localhost;port=3306;database=mydb;userid=root;password=122809394;persistsecurityinfo=True;", x => x.ServerVersion("8.0.20-mysql"));
            }
        }
